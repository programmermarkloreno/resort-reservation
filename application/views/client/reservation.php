                ...
                <div class="col-lg-6 order-lg-<?php echo $switchB; ?>">
                    <div class="ri-text">
                        <div class="section-title">
                            ...
                            <a href="<?php echo base_url(); ?>Client/acc/<?php if(isset($_SESSION["token"])) { echo $_SESSION["token"].'/'.$subcategorieskey["sub_category_id"].'/'.$subcategorieskey["parent_id"]; }?>" class="primary-btn">Make a Reservation</a>
                        </div>
                      </div>
                  </div>
                </div>
