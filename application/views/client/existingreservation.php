                ...
                <div class="col-lg-8">
                    <div class="contact-title">
                        <center>
                            ...
                            <h2>You have current reservation. Please accomodate this first. Before you reserve again.</h2>
                        </div></center>
                    </div>
                    <div class="info-box">
                     <form class="contact-form" method="post" action="<?php echo base_url(); ?>Client/invoice/<?php if(isset($_SESSION["token"])){ echo $_SESSION["token"]; }else { redirect('Client/signout'); } ?>">
