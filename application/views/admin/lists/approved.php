  ...
  <div class="content-wrapper">
      ...
      <div class="callout" style="background: white;color: #343B41;border-left: 5px solid #343B41;margin-bottom: 5px; box-shadow: 8px 5px 19px;">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <h4 style="margin:0px;font-size: 19px"><i class="fa fa-calendar-check"></i>&nbsp; Confirmed</h4>
          </div>
    ...
    <section class="content">
      ...
      <div class="modal fade" id="check-in-btn">
          <div class="modal-dialog">
            <form id="check-in-accomodation" class="form-horizontal" method="post" enctype="multipart/form-data" validate>
               <div class="modal-content">
                  <div class="modal-header bg-warning">
                    <h4 class="modal-title text-dark" style="color: white"> Check-In</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="color: white">&times;</button>
                  </div>

                  <div class="modal-body">
                    <div class="callout" style="background: white;color: #3a3232;border-left: none;padding: 15px">
                            <input class="form-control" type="hidden" name="rs-checkin-id" id="rs-checkin-id" value="">
                            <div class="row">
                              <div class="col-lg-12 form-group">
                                  <label for="pay_payment">Time In:</label>
                                  <input type="time" class="form-control" id="confirmed_time" name="confirmed_time" required>
                              </div>
                              <div class="col-lg-12 form-group">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-warning btn-down-update" style="border: #40b6f9;text-transform: uppercase;"> Check-In </button>
                  </div>
              </div>
            </form>
          </div>
            ...
            <form id="cancel-accomodation" class="form-horizontal" method="post" enctype="multipart/form-data" validate>
               <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" style="background: #40b6f9;border: #40b6f9;text-transform: uppercase;">Confirm</button>
                  </div>
              </div>
            </form>
          </div>
